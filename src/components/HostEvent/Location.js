...
const Location = ({place, setModalData}) => {
    ...
    return (
        <div className='borde shadow-2xl text-center py-8 rounded-lg'>
            ...
            <p className='pt-1'>
                {totalSlots} {totalSlots > 1 ? 'slots' : 'slot'} left
            </p>

            <label htmlFor="booking-modal" disabled={totalSlots === 0} className="btn btn-secondary my-4 font-semibold" onClick={() => setModalData(place)}>
                Book Now
            </label>
